...
def get_keyboard(lang="en"):
    ...
    if lang == "hi":
        ...
        markup.add("📝 फीडबैक", "❓ मदद", "💡 सलाह", "🔢 तथ्य", "🗓️ छुट्टियाँ", "💬 उद्धरण", "🐱 बिल्ली तथ्य", "📚 शब्दकोश", "🧠 सामान्य ज्ञान", "😂 चुटकुला", "💱 विनिमय दर")
    else:
        markup.add("🌧️ Weather", "⚠️ Alert", "🌊 Flood Zones", "💡 Tips")
        markup.add("🚗 Traffic", "📲 Subscribe", "❌ Unsubscribe", "🚨 Emergency")
        markup.add("📝 Feedback", "❓ Help", "💡 Advice", "🔢 Fact", "🗓️ Holidays", "💬 Quote", "🐱 Cat Fact", "📚 Dictionary", "🧠 Trivia", "😂 Joke", "💱 Exchange Rate")
    return markup
